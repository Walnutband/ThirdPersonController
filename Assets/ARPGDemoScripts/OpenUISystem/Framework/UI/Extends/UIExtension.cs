...
namespace SkierFramework
{
    ...
    public static class UIExtension
    {
        ...
        public static Canvas CreateLayerCanvas(UILayer layer, bool is3D, Transform parent, Camera camera, float width, float height)
        {
            ...
            canvasScaler.uiScaleMode = CanvasScaler.ScaleMode.ScaleWithScreenSize; //缩放模式，随屏幕尺寸缩放，重点是设置好锚点
            canvasScaler.referenceResolution = new Vector2(width, height); //参考分辨率

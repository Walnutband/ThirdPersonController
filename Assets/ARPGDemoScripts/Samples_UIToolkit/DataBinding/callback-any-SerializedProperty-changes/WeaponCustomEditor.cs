...
namespace UIToolkitExamples
{
    ...
    public class WeaponCustomEditor : Editor
    {
        ...
        //简单意思就是，获取基础伤害以及乘上了系数的伤害值，然后遍历两个伤害，只要有伤害值小于0就显示m_NegativeWarning警告信息即伤害值小于了最小值，
        // 而只要有伤害值大于最大值Weapon.maxDamage就显示m_DamageCapWarning警告信息机伤害值大于了最大值
        //总之还是比较实用的一个功能

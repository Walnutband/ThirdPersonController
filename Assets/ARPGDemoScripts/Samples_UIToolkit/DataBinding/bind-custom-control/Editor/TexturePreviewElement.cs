...
using Object = UnityEngine.Object; //命名空间别名，因为System也有一个object，这样就可以直接用Object，不需要添加UnityEngine来与System区别。

namespace UIToolkitExamples
{
    public class TexturePreviewElement_CustomControl : BindableElement, INotifyValueChanged<Object>
    {
        public new class UxmlTraits : BindableElement.UxmlTraits { }
        public new class UxmlFactory : UxmlFactory<TexturePreviewElement_CustomControl, UxmlTraits> { }
        ...
        public TexturePreviewElement_CustomControl()
        {

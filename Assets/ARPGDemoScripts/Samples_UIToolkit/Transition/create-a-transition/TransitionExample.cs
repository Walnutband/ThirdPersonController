...
public class TransitionExample : EditorWindow
{
    ...
    [MenuItem("Window/UI Toolkit/示例/TransitionExample")]
    ...
    public void CreateGUI()
    {
        ...
        VisualElement root = rootVisualElement; //不是很懂这里为何要单独用一个局部变量来引用，本来就可以直接访问。
        ...
        // Set up event handlers to simulate use of :hover pseudoclass.通过进入和退出事件来模拟hover悬停状态

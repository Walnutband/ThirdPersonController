...
namespace ARPGDemo.BuffSystemSample
{
    ...
    public class AoeState : MonoBehaviour
    {
        ...
        private UnitMove unitMove; //控制移动
        private UnitRotate unitRotate; //控制旋转
        ...
        //就是说每个Aoe本来都是相同的，而由于不同的AoeLauncher带来的数据不同，从而创建出了各种各样的Aoe。
        //在创建Aoe时依赖的是AoeModel和AoeLauncher，而实际运行时参与逻辑的是挂载在Aoe对象上的这里的AoeState组件

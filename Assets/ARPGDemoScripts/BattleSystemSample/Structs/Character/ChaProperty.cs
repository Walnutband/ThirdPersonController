...
namespace ARPGDemo.BuffSystemSample
{
    ...
    ///这个建一个结构是因为并非只有角色有这些属性，包括装备、buff、aoe、damageInfo等都会用上（因为各种效果，最终都要落实到这些基础属性）
    ///</summary>
    public struct ChaProperty
    {
        ...
        //Tip：由于没有借助物理引擎，所以在此专门设置记录半径的变量
        ///<summary>
        ///体型圆形半径，用于移动碰撞的，单位：米
        ...
        ///<summary>
        ///将所有值清0（就是恢复到无效果，但要看具体是什么属性，不一定数值为0就代表无效果）
    ...
    //
    ///<summary>
    ///角色的资源类属性（也就是可以作为资源的属性，属于角色属性的子集），比如hp，mp，sp等都属于这个
    ///</summary>

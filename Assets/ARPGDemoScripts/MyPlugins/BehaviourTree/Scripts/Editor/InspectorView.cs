...
namespace MyPlugins.BehaviourTree.EditorSection
{
    public class InspectorView : VisualElement {
        public new class UxmlFactory : UxmlFactory<InspectorView, UxmlTraits> { } //暴露在UI Build中
        ...
        internal void UpdateSelection(NodeView nodeView) { //通过NodeView获取数据节点Node，因为UI交互只能获取视图对象，比如这里的NodeView。
            ...
            */
            ...
            editor = Editor.CreateEditor(nodeView.node); //为数据节点创建一个编辑器，就相当于CustomEditor特性

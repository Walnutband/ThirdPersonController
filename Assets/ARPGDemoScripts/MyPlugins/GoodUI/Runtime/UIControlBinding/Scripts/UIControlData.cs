...
#region Editor
        ...
        private static Dictionary<string, Type> _typeMap = new Dictionary<string, Type>()
        {
            ...
            { nameof(SimpleButton), typeof(SimpleButton)},
            { nameof(AccordionGroup), typeof(AccordionGroup)},
            { nameof(AccordionElement), typeof(AccordionElement)},
            { nameof(HorizontalSnapper), typeof(HorizontalSnapper)},

...
namespace ARPGDemo.BattleSystem
{
    ...
    public delegate void BuffOnAdded(Buff buff);
    public delegate void BuffOnRemoved(Buff buff);
    public delegate void BuffOnTick(Buff buff);
    public delegate void BuffOnHit(Buff buff, ref DamageInfo damageInfo, GameObject target);
    public delegate void BuffOnBeHurt(Buff buff, ref DamageInfo damageInfo, GameObject attacker);
    public delegate void BuffOnKill(Buff buff, DamageInfo damageInfo, GameObject target);
    public delegate void BuffOnBeKilled(Buff buff, DamageInfo damageInfo, GameObject attacker);
    /**/

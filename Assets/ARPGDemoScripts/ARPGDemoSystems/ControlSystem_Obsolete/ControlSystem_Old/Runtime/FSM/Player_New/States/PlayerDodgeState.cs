...
namespace ARPGDemo.ControlSystem_Old
{
    ...
    public class PlayerDodgeState : PlayerStateBehaviour
    {
        ...
        [SerializeField] protected FadeAnimation roll;
        [SerializeField] protected FadeAnimation avoidBack;
        ...
        public override void OnEnterState()
        {
            ...
            if (moveInput == Vector2.zero)
            {
                ...
                m_CurrentState.EndedEvent += () => m_IsEnd = true;
            ...
            else
            {
                ...
                m_ActualMoveDir = transform.TransformDirection(new Vector3(0f, 0f, 1f)); //就是向前翻滚，翻滚时无关输入方向
                m_CurrentState = animPlayer.Play(roll);
                m_CurrentState.EndedEvent += () => m_IsEnd = true;
                m_CurrentState.CustomEndedEvent += () => 
                {

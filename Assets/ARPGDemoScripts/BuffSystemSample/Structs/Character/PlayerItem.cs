...
namespace ARPGDemo.BuffSystemSample
{
    ...
    public struct ItemModel
    {
        ...
        ///道具id
        ///</summary>
        public string id; //id为何不使用int值来表示？
        ...
        ///道具名称
        ///</summary>
        public string name; //应当是唯一的。（其实只要具有唯一性，那按理来说就可以充当ID）

        ///<summary>
        ///道具Tag（就是对不同道具进行分类，道具类型可以用于多种用途，比如任务目标、背包内排序等等，完全看游戏设计，总之这是不可没有的基础属性，属于游戏设计的基石）
        ///</summary>
        public string[] tags;

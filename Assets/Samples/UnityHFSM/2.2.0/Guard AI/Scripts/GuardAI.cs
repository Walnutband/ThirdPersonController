...
public class GuardAI : MonoBehaviour
{
    ...
    private Vector2 playerPosition => PlayerController.Instance.transform.position; //获取到玩家的位置。
    ...
    void Start()
    {
        ...
        // Fight FSM
        var fightFsm = new HybridStateMachine( //在每个状态的主要逻辑运行前一刻首先进行移动
        ...
        fsm.AddState("Fight", fightFsm); //嵌套状态机
    ...
    {
        //minDistance就是与目标所应该保持的最小距离，所以此次移动的距离必须小于等于  当前与目标的距离减去minDistance。

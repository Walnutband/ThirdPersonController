...
public class SimpleController_UsingActionAsset : MonoBehaviour
{
    ...
    public float burstSpeed; //其实对应的发射数量，按住时长乘以该值就是该次要发射的数量。
    ...
    //Tip：这里的Move和look方法很简洁，其实也具有很强的泛用性了。
    ...
    private IEnumerator BurstFire(int burstAmount)
    {
        ...
        {
            Fire();
            yield return new WaitForSeconds(0.1f);//每0.1s发射一个。
        }
    }

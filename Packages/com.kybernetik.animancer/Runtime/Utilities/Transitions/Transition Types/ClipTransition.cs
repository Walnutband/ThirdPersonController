...
namespace Animancer
{
        ...
        ICopyable<ClipTransition>
    {
        ...
        /// <summary>
        /// 转换开始的时刻（进度），通过勾选检视面板的Start Time，然后就可以设置了，否则是NaN。
        /// </summary>
        [SerializeField]
        [Tooltip(Strings.Tooltips.NormalizedStartTime)]
        [DefaultValue(float.NaN, 0f)]
        [AnimationTime(AnimationTimeAttribute.Units.Normalized, DisabledText = Strings.Tooltips.StartTimeDisabled)]

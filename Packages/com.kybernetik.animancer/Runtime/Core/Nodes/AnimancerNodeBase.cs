...
namespace Animancer
{
    ...
    public abstract class AnimancerNodeBase
    {
        ...
        /*Tip：AnimancerNode就是对于Playable节点的封装，也就是位于在更上一层，在同一层中的Graph就是AnimancerGraph，所以就是存储对于所在AnimancerGraph的引用，而不是
        PlayableGrpah的引用。*/
        /// <summary>The <see cref="AnimancerGraph"/> containing this node.
        /// <para>节点所在的Graph</para>
        /// </summary>

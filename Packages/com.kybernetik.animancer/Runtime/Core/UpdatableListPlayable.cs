...
namespace Animancer
{
    ...
    public class UpdatableListPlayable : PlayableBehaviour
    {
        ...
        /// <summary>Objects to be updated before time advances.
        /// <para>从AnimancerGraph中的<see cref="AnimancerGraph._PreUpdatables"/>和<see cref="AnimancerGraph._PostUpdatables"/>赋值。
        /// 即对应PlayableGraph中的两个UpdatableListPlayable节点</para>
        /// </summary>
        ...
        public static ScriptPlayable<UpdatableListPlayable> Create( AnimancerGraph graph, int inputCount, IUpdatable.List updatables)
        {
            ...
            var instance = playable.GetBehaviour(); //这里只是引用，不是新的实例。

...
namespace Animancer
{
    ...
    partial class AnimancerState
    {
        ...
        /// <summary>The system which manages the <see cref="SharedEvents"/>.
        /// <para>AnimancerState的事件分发器</para>
        /// </summary>
        ...
        public bool Events(object owner, out AnimancerEvent.Sequence events)
        {
            ...
            _EventDispatcher ??= new(this); //构造AnimancerEvent.Dispatcher实例。
        ...
        /// <summary>[Internal] Should this state check for events to invoke?
        /// <para>是否应该触发事件（是否具有触发事件的基本条件）</para>
        /// </summary>

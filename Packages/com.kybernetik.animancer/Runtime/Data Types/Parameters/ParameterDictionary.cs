...
namespace Animancer
{
    ...
    public class ParameterDictionary : IEnumerable<IParameter>
    {
        ...
        /// <summary>Gets an existing parameter registered with the `key` or creates one if necessary.
        /// <para>查找字典，创建的话就是StringReference（StringAsset）与Parameter<T>的键值对<para>
        /// </summary>
        /// <remarks>The `key` must not be null or empty.</remarks>

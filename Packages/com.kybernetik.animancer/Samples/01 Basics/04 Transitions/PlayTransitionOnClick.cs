...
namespace Animancer.Samples.Basics
{
    ...
    public class PlayTransitionOnClick : MonoBehaviour
    {
        ...
        //从直接引用AnimationClip改为了ClipTransition，封装了一些其他内容，并且可以在专门编写的检视器中进行图形化编辑。
        ...
        {
            //Transition的FadeDuration就是过渡时间，播放Transition就是以该过渡时间逐渐过渡到该Transition所对应的Clip
        ...
        protected virtual void Update()
        {
            if (SampleInput.LeftMouseUp)
            {
                ...
                //直接使用第二个参数作为过渡时间，可以直接AnimationClip引用。
                ...
                //Tip：FadeMode.FromStart这是立刻中断当前正在进行的转换吗？

    ...
    public sealed class InputActionMap : ICloneable, ISerializationCallbackReceiver, IInputActionCollection2, IDisposable
    {
        ...
        internal void ResolveBindings()
        {
            ...
            using (InputActionRebindingExtensions.DeferBindingResolution())
            {
                ...
                try
                {
                    OneOrMore<InputActionMap, ReadOnlyArray<InputActionMap>> actionMaps; //容器好就好在可以同时处理单个元素以及多个元素的情况（甚至是无元素的情况）
                    ...
                    //Tip：如果该Map位于一个Asset中，那么就会同时解析在该Asset中的所有Map，如果没有在Asset中，就只是解析自己。
                    if (m_Asset != null)
                    {
